...
namespace Husky_Air
{
    public partial class DoctorLogin : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string query = "Select count(*) from Doctor where Emailid='" + TextBox1.Text + "'";
            ...
            {
                con.Open();
                string checkpassword = "select Password from Doctor where Emailid='" + TextBox1.Text + "'";
                string status = "select status from Doctor where Emailid='" + TextBox1.Text + "'";
